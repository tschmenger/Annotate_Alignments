	...
	for k in idc:
			...
			for oldline in content:
				...
				try:
					...
					if "FT" in line and "VARIANT" in line:
						if checker == "FALSE":	### this will happen when I get to such a line:			FT   VARIANT         47
							...
							checker = "TRUE"
							checktype = "VARIANT"
					elif "FT" in line and "MUTAGEN" in line:
						...
						if "FT" in line:
							if checker == "FALSE":	### this will happen when I get to such a line:			FT   MUTAGEN         226
								...
								checker = "TRUE"
								checktype = "BINDING"
					elif "FT" in line and "MOD_RES" in line:	### this will happen when I get to such a line:			FT   BINDING         38
						if checker == "FALSE":	### this will happen when I get to such a line:			FT   MUTAGEN         226
							comment = ""
							newline = whitespace_killer.sub(" ",line).replace("\n","")
							position = newline.split(" ")[2]
							checker = "TRUE"
							checktype = "MOD_RES"
					elif "FT" in line and "ACT_SITE" in line:
