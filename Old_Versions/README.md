...
or using **example** `python Create_Information3.py RHOA_BlastP_sequences.txt >> RHOA_Blastp_info.txt`.
...
`python Annotate_Alignment_V6.py P61586 34 30 RHOA_BlastpExample_ClustalMSA.clustal RHOA_Blastp_info.txt Features_RHOA.txt` 
